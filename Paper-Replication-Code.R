...
# 20 Year Linear Decay PWP Gap Time Models - Table 1 of Paper
...
# 20 Year Linear Decay PWP Elapsed Time Models - Table 2 of Paper
...
# Using Combined Favorable for Sovereign State Variable
...
# PWP Gap Time Model 20 Year Linear Decay - Disaggregated
...
# PWP Gap Time Model 20 Year Linear Decay - Electoral Democracy
...
tc23_pwp_elec <- coxph(tc23_gap ~ peace_wtc + fighting_wtc  +
                          force_lin_decay + favor_tc_lin_decay +
                          absorb_lin_decay + elec_dem_vdem + area_1000_log +
                          lmtnest + elf + strata(event_num) + cluster(ccode),
                        data = tc23, method = "efron")

tc45_pwp_elec <- coxph(tc45_gap ~ peace_wtc + fighting_wtc +
                          force_lin_decay + favor_tc_lin_decay +
                          absorb_lin_decay + elec_dem_vdem + area_1000_log +
                          lmtnest + elf + strata(event_num) + cluster(ccode),
                        data = tc45, method = "efron")
...
# PWP Gap Time Model 20 Year Linear Decay - State Failure Control
...
# 20 Year Linear Decay PWP Gap Time Models - Polity 2
...
# PWP Gap Time Models - 10 Year Binary
...
tc23_pwp_t10 <- coxph(tc23_gap ~ peace_wtc + fighting_wtc  +
                          force_t10 + favor_tc_t10 +
                          absorb_t10 + lib_dem_vdem + area_1000_log +
                          lmtnest + elf + strata(event_num) + cluster(ccode),
                        data = tc23, method = "efron")

tc45_pwp_t10 <- coxph(tc45_gap ~ peace_wtc + fighting_wtc +
                          force_t10 + favor_tc_t10 +
                          absorb_t10 + lib_dem_vdem + area_1000_log +
                          lmtnest + elf + strata(event_num) + cluster(ccode),
                        data = tc45, method = "efron")

tc6_more_pwp_t10 <- coxph(tc6_more_gap ~ peace_wtc + fighting_wtc  +
                              force_t10 + favor_tc_t10 +
                              absorb_t10 + lib_dem_vdem + area_1000_log +
                              lmtnest + elf + strata(event_num) +
                              cluster(ccode), data = tc6_more, method = "efron")
...
# PWP Gap Time Models - 20 Year Binary
...
tc23_pwp_t20 <- coxph(tc23_gap ~ peace_wtc + fighting_wtc  +
                        force_t20 + favor_tc_t20 +
                        absorb_t20 + lib_dem_vdem + area_1000_log +
                        lmtnest + elf + strata(event_num) + cluster(ccode),
                      data = tc23, method = "efron")

tc45_pwp_t20 <- coxph(tc45_gap ~ peace_wtc + fighting_wtc +
                        force_t20 + favor_tc_t20 +
                        absorb_t20 + lib_dem_vdem + area_1000_log +
                        lmtnest + elf + strata(event_num) + cluster(ccode),
                      data = tc45, method = "efron")

tc6_more_pwp_t20 <- coxph(tc6_more_gap ~ peace_wtc + fighting_wtc  +
                            force_t20 + favor_tc_t20 +
                            absorb_t20 + lib_dem_vdem + area_1000_log +
                            lmtnest + elf + strata(event_num) +
                            cluster(ccode), data = tc6_more, method = "efron")
...
# PWP Gap Time Models - Exponential 5 Year Halflife
...
# PWP Gap Time Models - Exponential 10 Year Halflife
...
# PWP Gap Time Models - Exponential 15 Year Halflife
...
# PWP Gap Time Models - Exponential 20 Year Halflife
